...
public class productAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = productObj.insertproduct(
				request.getParameter("prname"), 
				request.getParameter("prdate"), 
				request.getParameter("prdate")
				); 
				response.getWriter().write(output);
				
				String jspName = request.getParameter("hidpidSave");
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 paras.get("prdate").toString(), 
		 paras.get("prdes").toString(), 
		 
		 Integer.parseInt((String) paras.get("hidpid")));
		 response.getWriter().write(output); 
	}
